...
def img_to_base64(image):
    ...
    Args:
        image: PIL.Image - The image to be converted. PIL refers to Python Imaging Library
    Returns:
...
def get_allowed_model_names(models_info: dict) -> tuple:
    ...
    """
    allowed_models = ["bakllava:latest", "llava:latest"] #these models are multimodal in nature
    return tuple(
        model
...
def main():
    page_icon("🌋")
    st.subheader("LLaVA 1.6 Arena", divider="red", anchor=False)
